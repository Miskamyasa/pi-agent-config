...
- `pi-memory-mnemosyne` - semantic memory backed by a hosted Mnemosyne server (patched fork of [TGYD-helige/pi-memory-mem0](https://github.com/TGYD-helige/pi/tree/master/packages/pi-memory-mem0)).
